        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Customer_StationaryStoreId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_StationaryStore_Customer_StationaryStoreId",
                        column: x => x.Customer_StationaryStoreId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Addresses_StationaryStore_StationaryStoreId",
                        column: x => x.StationaryStoreId,
                        principalTable: "StationaryStore",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Products_StationaryStore_StationaryStoreId",
                        column: x => x.StationaryStoreId,
                        principalTable: "StationaryStore",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_Customer_StationaryStoreId",
                table: "AspNetUsers",
