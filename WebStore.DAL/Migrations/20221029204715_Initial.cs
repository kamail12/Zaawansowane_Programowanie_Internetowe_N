    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WebStoreUsers", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShippingAddress_CustomerId = table.Column<int>(type: "int", nullable: true),
                    StationaryStoreId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Addresses_WebStoreUsers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "WebStoreUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Addresses_WebStoreUsers_ShippingAddress_CustomerId",
                        column: x => x.ShippingAddress_CustomerId,
                        principalTable: "WebStoreUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUserClaims_WebStoreUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "WebStoreUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUserLogins_WebStoreUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "WebStoreUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AspNetUserRoles_WebStoreUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "WebStoreUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUserTokens_WebStoreUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "WebStoreUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Addresses_ShippingAddress_CustomerId",
                table: "Addresses",
                column: "ShippingAddress_CustomerId");
